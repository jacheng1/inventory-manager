...
export async function generateRecipe(ingredients) {
    const chatCompletion = await groq.chat.completions.create({
        messages: [
            {
                role: "system",
                content: "You are a professional chef specializing in creating recipes from available ingredients. Your task is to suggest a recipe based on the provided ingredients to the best of your ability, with emphasis towards taste and popularity."
            },
            {
                role: "user",
